        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <Link to="/" className="flex-shrink-0">
              <h1 className="text-xl font-bold">ResQ</h1>
            </Link>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-4">
              ...
              <Link to="/solucao" className="hover:bg-blue-700 px-3 py-2 rounded-md">Solução</Link>
              <Link to="/sobre" className="hover:bg-blue-700 px-3 py-2 rounded-md">Sobre</Link>
              <Link to="/login" className="hover:bg-blue-700 px-3 py-2 rounded-md">Login</Link>
              <Link to="/cadastrar" className="bg-white text-blue-600 hover:bg-blue-100 px-3 py-2 rounded-md">Cadastrar</Link>
            </div>
          </div>
